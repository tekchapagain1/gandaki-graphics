...
const SOCIAL_LINKS = [
  {
    label: 'Instagram',
    href: 'https://instagram.com/gandakigraphics',
    icon: (
  ...
  {
    label: 'Facebook',
    href: 'https://facebook.com/gandakigraphics',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        <path d="M13.5 22v-8h2.7l.4-3.1h-3.1V8.6c0-.9.3-1.6 1.6-1.6h1.7V4.1c-.3 0-1.4-.1-2.7-.1-2.7 0-4.6 1.6-4.6 4.7v2.2H7v3.1h2.5v8h4z" />
      </svg>
    ),
  },
  {
    label: 'WhatsApp',
    href: 'https://wa.me/9779769499307?text=Hi%20Gandaki%20Graphics!%20I%20want%20to%20start%20an%20order.',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
    ...
    <div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        ...
        <p className="text-sm font-light text-gray-400 max-w-md">
          Questions, quotes, or just want to say hi? Start an order, call, or email us and we&apos;ll help you move quickly.
        </p>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-6 pb-16 grid md:grid-cols-5 gap-10">
        ...
        <div className="md:col-span-3 flex flex-col gap-4">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <Link
              href="/order"
              className="group flex items-center gap-5 p-6 bg-gray-900 hover:bg-gray-800 rounded-2xl transition-colors"
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-white font-medium text-sm mb-0.5">Start an order</p>
                <p className="text-gray-400 text-xs font-light">Upload a design file or send it later</p>
              </div>
            ...
            <a
              href={`mailto:${EMAIL}`}
              className="group flex items-center gap-5 p-6 card hover:border-gray-200 hover:shadow-sm transition-all"
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs font-light text-gray-400 truncate">{EMAIL}</p>
              </div>
        ...
        <div className="md:col-span-2 flex flex-col gap-4">
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-xl p-5">
            ...
            <p className="text-xs font-light text-blue-700 leading-relaxed">
              Uploading your design file with the order form is the fastest way to get an accurate quote. If you prefer messaging, use the social links below.
            </p>
          </div>

          <div className="card p-5">
            <p className="text-xs font-medium tracking-widest uppercase text-gray-400 mb-3">Social links</p>
            <div className="flex flex-wrap gap-3">
              {SOCIAL_LINKS.map((link) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-200 text-sm font-medium text-gray-700 hover:border-gray-400 hover:bg-gray-50 transition-colors"
                >
